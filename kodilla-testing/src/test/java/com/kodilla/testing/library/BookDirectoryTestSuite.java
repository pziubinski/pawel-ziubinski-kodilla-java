...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryUser userWith0Books = new LibraryUser("User", "One", "123456789");
        when(libraryDatabaseMock.listBooksInHandsOf(userWith0Books)).thenReturn(resultListOf0Books);

        LibraryUser userWith1Book = new LibraryUser("Admin", "Two", "321654987");
        when(libraryDatabaseMock.listBooksInHandsOf(userWith1Book)).thenReturn(resultListOf1Books);

        LibraryUser userWith5Books = new LibraryUser("SuperUser", "Three", "000000000");
        ...
        List<Book> theListOfBooks1 = bookLibrary.listBooksInHandsOf(userWith1Book);
